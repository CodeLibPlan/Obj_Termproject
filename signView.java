...
/**
 * Created by chm31 on 2017-12-03.
 */
...
public class signView extends View {
    ...
    public void colorChanged(int color) {
        ...
        if (DrawActivity.D) Log.e(getClass().getSimpleName(), "여기서 세팅?" + color);
    ...
    public signView(Context context, AttributeSet attrs) {
        ...
        mBitmap = Bitmap.createBitmap(1050, 1600, Bitmap.Config.ARGB_8888); // 영역크기
        // mBitmap = Bitmap.createBitmap(1050, 1600,Bitmap.Config.); // 영역크기
    ...
    */
    ...
    class ReceiveMessageCallback implements CallbackEvent<String[]> {
        ...
        public void run(String[] input) {
            ...
            //draw는 로그인 다음
            //NetworkManager.draw(input[1].split(",")[0]+","+input[1].split(",")[1]);
            /*Random r = new Random();*/
            // touch_start(Float.parseFloat(input[1].split(",")[0]), Float.parseFloat(input[1].split(",")[1]));
            mPath.lineTo(Float.parseFloat(input[1].split(",")[0]), Float.parseFloat(input[1].split(",")[1]));
            //mCanvas.drawPath(mPath, mPaint);
            //touch_up();
